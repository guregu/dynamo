...
func (c *coffeeItemFlat) UnmarshalDynamoItem(item dynamo.Item) error {
...
func (c *coffeeItemInvalid) UnmarshalDynamoItem(item dynamo.Item) error {
...
func (c *coffeeItemEmbedded) UnmarshalDynamoItem(item dynamo.Item) error {
...
func (c *coffeeItemEmbeddedPointer) UnmarshalDynamoItem(item dynamo.Item) error {
...
func (c *coffeeItemSDKEmbeddedPointer) UnmarshalDynamoItem(item dynamo.Item) error {
	type alias coffeeItemEmbeddedPointer
	aux := struct {
		*alias
	}{
